...
=begin
  - compare the length objects in order to sort them
  - compare 1 mi with 1 nmi
    - other.as_miles.value
      - creates a new lenght object with the original objects value converted to miles
=end
